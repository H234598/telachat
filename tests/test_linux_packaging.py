...
class LinuxPackagingTests(unittest.TestCase):
    ...
    def test_make_installer_smoke_uses_temporary_desktop_directory(self) -> None:
        ...
        self.assertIn("Installed Telachat 0.69.0", result.stdout)
        self.assertIn("telachat 0.69.0", result.stdout)
    ...
    def test_installer_installs_zipapp_launchers_desktop_file_and_icon(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("telachat 0.69.0", version)
    ...
    def test_packaging_files_are_present_for_periodic_release_artifacts(self) -> None:
        ...
        self.assertTrue(any(rpm_root.rglob("telachat-0.69.0-*.noarch.rpm")))
